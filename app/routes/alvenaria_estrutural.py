...
def alvenaria():
    ...
    if request.method == 'POST':
        ...
        acaoperm1 = request.form.get("acaoperm1")
        acaovar1 = request.form.get("acaovar1")
        bloco1 = request.form.get("bloco1")
        lajep1 = request.form.get("lajep1")
        lajev1 = request.form.get("lajev1")
        peso1 = request.form.get("peso1")
        pav1 = request.form.get("pav1")
        estr1 = request.form.get("estr1")
        larg1 = request.form.get("larg1")
        argamassa1 = request.form.get("argamassa1")
        ...
        if file:
            ...
            n_rd, n_sd, g_0, dados_parede = projeto_paredes_compressao(
                df, gamma_f, gamma_w, f_pk, g_laje, q_laje, g_pare, n_pavtos, comp_estrutura, larg_estrutura, tipo_argamassa)
            return jsonify({
                'n_rd': n_rd,
                'n_sd': n_sd,
                'g_0': g_0,
                'dados_parede': dados_parede.to_dict(orient='records')
            })
