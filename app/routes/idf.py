...
import pandas as pd
from app.utils.calculos import vazio, download_excel, calculo_precipitacoes, problema_inverso_idf, indice_spi, tutorial_idf, teoria_idf, pbl_idf, tutorial_spi, teoria_spi, pbl_spi

idf = Blueprint('idf', __name__)
